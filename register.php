...
Welcome to BingLoft Advertisement Network!

Just one more step to complete your registration with BingLoft! Please click bellow link or alternatively copy and paste the url to your browser!
...
echo '<div class="form"><div id="forgot"><b>Personal Information:</b></div>
<form method="post"><label for="firstname">First Name:<font color="red">*</font></label><br/><input type="text" name="firstname"/><br/><label for="lastname">Last name / Surname:<font color="red">*</font></label><br/><input type="text" name="lastname"/><br/><label for="address1">Address 1:<font color="red">*</font></label><br/><textarea name="address1"></textarea><br/><label for="address2">Address 2:</label><br/><textarea name="address2"></textarea><br/><label for="state">State / Region:</label><br/><input type="text" name="state"/><br/><label for="city">City:<font color="red">*</font></label><br/><input type="text" name="city"/><br/><label for="zip">Zip / Postal Code:<font color="red">*</font></label><br/><input type="text" name="zip"/><br/><label for="country">Country:<font color="red">*</font></label><br/><select name="country">
